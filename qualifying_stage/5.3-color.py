...
from tkinterColors import COLORS
...
class Figure:
    ...
    def __init__(self, field, center_coords, angles):
        ...
        self.__object = field.create_polygon(*self.__vertexes, fill=choice(COLORS))  # Polygon object
    ...
    def __add_vertex(self):
        ...
        self.__angles += 1
        self.__vertexes = self.__get_vertexes()  # List of vertexes coordinates
        self.__object = self.__field.create_polygon(*self.__vertexes, fill=choice(COLORS))  # Polygon object
        self.__field.tag_bind(self.__object, '<Button-1>', self.transform)
